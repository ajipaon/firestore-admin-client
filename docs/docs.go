    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controller.GenericResponse"
                        }
                    },
                    "401": {
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "HTML response with token",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "400": {
                        "description": "HTML error response",
                        "schema": {
                            "type": "string"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/lib.LoginRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/lib.GenericResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
